...
<header id="pc-header">
            ...
            <div class="div1_3">
	           <form>
		            <c:forEach var="item" items="${client_the_life_tool }">
			            <div class="div3_4">
			            ...
			            <div class="div3_5">
				            <div class="div5_1">
					            <img src="${item.tool_img_path }" data-index='1' />
				            </div>
				            <div class="div5_2">
					            <img src="${item.tool_img_path }" data-index='2' />
				            </div>
				            <div class="div5_3">
					            <img src="${item.tool_img_path }" data-index='3' />
				            </div>
				            <div class="div5_4">
					            <img src="${item.tool_img_path }" data-index='4' />
				            </div>
				            <div class="div5_5">
					            <img src="${item.tool_img_path }" data-index='5' />
				            </div>
			            </div>
			            ...
			            <div class="div3_6">
				            ...
				            <div class="div6_8">
					            <p>价格 :&nbsp;<span>￥${item.tool_price }</span></p>
					            <br />
					            <p>类别 :&nbsp;<span>${item.tool_type }</span></p>
					            <br />
					            <p>可购买数量 :&nbsp;<span>${item.tool_number }</span></p>
				            </div>
				            ...
				            <div class="div6_10">
					            ...
					            <p>
					            	数量
						            <input id="goods_number" name="goods_number" type="text" value="" class="number"/>
					            </p>
				            </div>
				            ...
				            <div class="div6_11">
					            ...
					            <input type="submit" value="立刻购买" onclick="clientBuyLifeTool()" class="add_shopping_car_submit"/>
