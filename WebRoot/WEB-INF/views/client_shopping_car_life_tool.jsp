...
<header id="pc-header">
			...
			<div class="pc-header-logo clearfix">
				...
				<div class="fr pc-head-car">
					<i class="icon-car"></i>
					<a href="client_select_shopping_pet" target="_blank">用品购物车</a>
				</div>
			</div>
			...
			<c:forEach var="item" items="${client_life_tool_all }">
				<div class="shopping_car_goods_list">
					...
					<div class="shopping_car_goods_content">
						...
						<br /><br />
						<sapn>用 品 尺 寸 :</sapn><sapn>${item.tool_size }</sapn>
						<br /><br />
						<sapn>用 品 重 量 :</sapn><sapn>${item.tool_weight }</sapn>
					</div>
					...
					<div class="shopping_car_goods_operation">
						<a href="client_delect_shoppping_car_the_life_tool?shopping_id=${item.shopping_id }" style="color: white;">移除</a>
						<i>&nbsp;&nbsp;&nbsp;&nbsp;</i>
						<a href="client_settlement_life_tool?goods_id=${item.goods_id }" style="color: white;">结算</a>
					</div>
				</div>
			</c:forEach>
